    ...
    export default {
        globalData: {
            data: {
				...
				static_url: 'https://www.shidafeng.net/sdf/file/local-plus/upload/image/',
			...
			get_request_url(a='', params) {
				...
				url = url + join + 'token=' + token + params;
			    return url
			},
			get_request_url2(a, c, plugins, params, group) {
			                a = a || 'index';
			                c = c || 'index';
                ...
                uni.getNetworkType({
                    success: function (res) {
                        if (res.networkType != 'none') {
                            ...
                            // 读取远程配置
                            uni.request({
                                url: self.get_request_url('home/common'),
                                method: 'GET',
                                data: {
                                    is_key: 1,
                                },
