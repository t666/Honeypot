                ...
                <view class="user-top bg-white">
                    <view class="head-base pr flex-row jc-sb align-c">
                        ...
                        <view class="head-right cr-black">
                            ...
                            <view v-if="0" class="item pr dis-inline-block margin-left-xxl" data-value="/pages/message/message" @tap="url_event">
                    ...
                    <!-- 副导航 -->
                    <view v-if="0" class="head-nav oh padding-main flex-row align-c jc-sa tc">
                    ...
                    <!-- 会员码 付款码 -->
                    <view v-if="0" class="qrcode padding-horizontal-main pr oh">
