    ...
    <view :class="theme_view">
        ...
        <view v-if="goods != null" :class="'page ' + (is_single_page == 1 ? ' single-page-top' : '')">
            ...
            <view class="goods-base-price bg-white oh spacing-mb" :class="plugins_seckill_is_valid ? 'goods-base-price-countdown' : ''">
                ...
                <view v-if="0" :class="'padding-horizontal-main padding-top-main '+((plugins_seckill_is_valid) ? 'padding-bottom-main' : '')">
                ...
                <block v-else>
                    <!-- 右侧操作 -->
                    <view class="goods-base-right-opt padding-top-lg padding-bottom-lg padding-left-xs padding-right-main fr oh" v-if="0">
                        <!-- 收藏 -->
            ...
            <view class="padding-horizontal-main">
                ...
                <view class="goods-base-content border-radius-main bg-white spacing-mb">
                    <view class="padding-main">
                        <view class="goods-title-content oh flex-row jc-sb align-c">
                            ...
                            <view v-if="0" class="flex-row align-c padding-left-main">
                                <!-- 分享 -->
                    ...
                    <!-- 基础总计数据 -->
                    <view v-if="0" class="br-t padding-main">
                ...
                <!-- 面板提示信息 -->
                <view v-if="0" class="goods-panel-container oh border-radius-main padding-horizontal-main padding-top-xs padding-bottom-xs bg-white text-size-xs spacing-mb">
                ...
                <!-- 智能工具-基础提示信息 -->
                <view v-if="0" class="plugins-intellectstools-base-bottom-container spacing-mb">
                ...
                <!-- 优惠券 -->
                <view v-if="0" class="plugins-coupon-container-view pr oh padding-main border-radius-main bg-white text-size-xs spacing-mb flex-row jc-sb align-c">
                ...
                <!-- 规格选择 -->
                <view v-if="0" class="spec-container-view oh padding-horizontal-main padding-main border-radius-main bg-white text-size-xs spacing-mb">
            ...
            <view class="padding-horizontal-main">
                <!-- 商品基础参数 -->
                <view v-if="0" class="goods-parameters parameters-base border-radius-main padding-main bg-white text-size-xs spacing-mb flex-row jc-sb align-c" @tap="popup_params_event" data-value="base">
                ...
                <!-- 商品服务 -->
                <view v-if="0" class="plugins-goodsservice-view-container border-radius-main padding-main bg-white text-size-xs spacing-mb flex-row jc-sb align-c" @tap="popup_goodsservice_event">
                ...
                <!-- 门店 -->
                <view v-if="0" class="plugins-realstore-container">
                ...
                <!-- 商品评价 -->
                <view v-if="0" class="goods-comment spacing-mb">
                    <view class="spacing-nav-title flex-row align-c jc-sb text-size-xs">
                ...
                <!-- 猜你喜欢 -->
                <view v-if="0" class="padding-horizontal-main margin-top-main">
            ...
            <!-- 购买记录 -->
            <view v-if="0" :class="'plugins-salerecords-tips' + plugins_salerecords_tips_ent">
